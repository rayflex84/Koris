...
import com.torepofficiel.carem.koris.ui2.camera.BarcodeCaptureActivity;
...
public class BarcodeMainActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.read_barcode) {
            ...
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP
                    && isCamera2Native()){
                // launch barcode activity for camera 2 api.
                ...
                intent = new Intent(this, com.torepofficiel.carem.koris.ui1.camera.BarcodeCaptureActivity.class);
                intent.putExtra(com.torepofficiel.carem.koris.ui1.camera.BarcodeCaptureActivity.AutoFocus, autoFocus.isChecked());
                intent.putExtra(com.torepofficiel.carem.koris.ui1.camera.BarcodeCaptureActivity.UseFlash, useFlash.isChecked());
            }
    ...
    public boolean isCamera2Native() {
        try {
            if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {return false;}
